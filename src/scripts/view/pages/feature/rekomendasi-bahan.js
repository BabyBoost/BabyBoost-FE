...
class RekomendasiBahanPage {
  ...
  _render() {
    ...
    <div class="rekomendasi-bahan-content-container">
        <div class="rekomendasi-bahan-content">
            <div class="rekomendasi-bahan-top">
              <div class="food-type">
                  ...
                  <h2 class="fw-bolder">Karbohidrat</h2>
              </div>
              <a href="/#/karbohidrat" class="text-black fs-5 lh-base">Lihat Semua</a>  
            </div>
            <div class="carousel-item active" id="item-karbohidrat">
            <div class="card-container">
                <div class="card">
                  <div class="card-body">
                    <img alt="img-food" id="item-karbohidrat-gambar-bahan-karbo-1" class="lazyload">
                    <div class="card-body-details">
                      <h5 id="item-karbohidrat-nama-bahan-karbo-1"></h5>
                      <h6 class="type-of-food" id="item-karbohidrat-type-of-food-karbo-1"></h6>
                      <div class="dose-detail">
                          ...
                          <h6 id="item-karbohidrat-takaran-bahan-karbo-1"></h6>
                      </div>
                      <div class="weight-detail">
                          ...
                          <h6 id="item-karbohidrat-berat-bahan-karbo-1"></h6>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card">
                  <div class="card-body">
                    <img alt="img-food" id="item-karbohidrat-gambar-bahan-karbo-2" class="lazyload">
                    <div class="card-body-details">
                      <h5 id="item-karbohidrat-nama-bahan-karbo-2"></h5>
                      <h6 class="type-of-food" id="item-karbohidrat-type-of-food-karbo-2"></h6>
                      <div class="dose-detail">
                          <svg width="22" height="20" viewBox="0 0 23 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M20.0874 0C21.216 0 22.13 0.915076 22.13 2.0426V4.426C22.13 6.48572 21.4916 8.49481 20.3026 10.1767C19.1137 11.8587 17.4327 13.1308 15.491 13.818V14.9378C15.491 15.3779 15.3161 15.8001 15.0049 16.1114C14.6936 16.4226 14.2714 16.5975 13.8312 16.5975H8.29875C7.85856 16.5975 7.43639 16.4226 7.12513 16.1114C6.81387 15.8001 6.639 15.3779 6.639 14.9378V13.818C4.69729 13.1308 3.01629 11.8587 1.82736 10.1767C0.638435 8.49481 2.501e-05 6.48572 0 4.426V2.0426C0 0.913969 0.915075 0 2.0426 0H20.0874Z" fill="#7C766B"/>
                          </svg>
                          <h6 id="item-karbohidrat-takaran-bahan-karbo-2"></h6>
                      </div>
                      <div class="weight-detail">
                          <svg width="23" height="21" viewBox="0 0 23 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11.0674 5.39741C11.5207 5.39741 11.901 5.24381 12.2082 4.93661C12.5154 4.62941 12.6684 4.24968 12.6674 3.79741C12.6674 3.34408 12.5138 2.96381 12.2066 2.65661C11.8994 2.34941 11.5196 2.19635 11.0674 2.19741C10.614 2.19741 10.2338 2.35101 9.92657 2.65821C9.61937 2.96541 9.46631 3.34515 9.46737 3.79741C9.46737 4.25075 9.62097 4.63101 9.92817 4.93821C10.2354 5.24541 10.6151 5.39848 11.0674 5.39741ZM13.8034 5.39741H17.557C18.213 5.39741 18.7783 5.60755 19.253 6.02781C19.7266 6.44808 20.0092 6.98355 20.101 7.63421L22.1042 21.6662C22.2172 22.4406 22.0167 23.1233 21.5026 23.7142C20.9884 24.303 20.3303 24.5974 19.5282 24.5974H2.60657C1.80444 24.5974 1.14631 24.3025 0.632174 23.7126C0.118041 23.1227 -0.0824925 22.4401 0.0305742 21.6646L2.03377 7.63421C2.12551 6.98355 2.40817 6.44808 2.88177 6.02781C3.35751 5.60755 3.92337 5.39741 4.57937 5.39741H8.33298C8.19217 5.17128 8.07964 4.92168 7.99537 4.64861C7.91004 4.37448 7.86737 4.09075 7.86737 3.79741C7.86737 2.89501 8.17511 2.13608 8.79057 1.52061C9.40604 0.905146 10.165 0.597412 11.0674 0.597412C11.9698 0.597412 12.7287 0.905146 13.3442 1.52061C13.9596 2.13608 14.2674 2.89501 14.2674 3.79741C14.2674 4.09075 14.2252 4.37448 14.141 4.64861C14.0567 4.92168 13.9442 5.17128 13.8034 5.39741Z" fill="#7C766B"/>
                          </svg>
                          <h6 id="item-karbohidrat-berat-bahan-karbo-2"></h6>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card">
                  <div class="card-body">
                    <img alt="img-food" id="item-karbohidrat-gambar-bahan-karbo-3" class="lazyload">
                    <div class="card-body-details">
                      <h5 id="item-karbohidrat-nama-bahan-karbo-3"></h5>
                      <h6 class="type-of-food" id="item-karbohidrat-type-of-food-karbo-3"></h6>
                      <div class="dose-detail">
                        <svg width="22" height="20" viewBox="0 0 23 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M20.0874 0C21.216 0 22.13 0.915076 22.13 2.0426V4.426C22.13 6.48572 21.4916 8.49481 20.3026 10.1767C19.1137 11.8587 17.4327 13.1308 15.491 13.818V14.9378C15.491 15.3779 15.3161 15.8001 15.0049 16.1114C14.6936 16.4226 14.2714 16.5975 13.8312 16.5975H8.29875C7.85856 16.5975 7.43639 16.4226 7.12513 16.1114C6.81387 15.8001 6.639 15.3779 6.639 14.9378V13.818C4.69729 13.1308 3.01629 11.8587 1.82736 10.1767C0.638435 8.49481 2.501e-05 6.48572 0 4.426V2.0426C0 0.913969 0.915075 0 2.0426 0H20.0874Z" fill="#7C766B"/>
                        </svg>
                        <h6 id="item-karbohidrat-takaran-bahan-karbo-3"></h6>
                      </div>
                      <div class="weight-detail">
                        <svg width="23" height="21" viewBox="0 0 23 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M11.0674 5.39741C11.5207 5.39741 11.901 5.24381 12.2082 4.93661C12.5154 4.62941 12.6684 4.24968 12.6674 3.79741C12.6674 3.34408 12.5138 2.96381 12.2066 2.65661C11.8994 2.34941 11.5196 2.19635 11.0674 2.19741C10.614 2.19741 10.2338 2.35101 9.92657 2.65821C9.61937 2.96541 9.46631 3.34515 9.46737 3.79741C9.46737 4.25075 9.62097 4.63101 9.92817 4.93821C10.2354 5.24541 10.6151 5.39848 11.0674 5.39741ZM13.8034 5.39741H17.557C18.213 5.39741 18.7783 5.60755 19.253 6.02781C19.7266 6.44808 20.0092 6.98355 20.101 7.63421L22.1042 21.6662C22.2172 22.4406 22.0167 23.1233 21.5026 23.7142C20.9884 24.303 20.3303 24.5974 19.5282 24.5974H2.60657C1.80444 24.5974 1.14631 24.3025 0.632174 23.7126C0.118041 23.1227 -0.0824925 22.4401 0.0305742 21.6646L2.03377 7.63421C2.12551 6.98355 2.40817 6.44808 2.88177 6.02781C3.35751 5.60755 3.92337 5.39741 4.57937 5.39741H8.33298C8.19217 5.17128 8.07964 4.92168 7.99537 4.64861C7.91004 4.37448 7.86737 4.09075 7.86737 3.79741C7.86737 2.89501 8.17511 2.13608 8.79057 1.52061C9.40604 0.905146 10.165 0.597412 11.0674 0.597412C11.9698 0.597412 12.7287 0.905146 13.3442 1.52061C13.9596 2.13608 14.2674 2.89501 14.2674 3.79741C14.2674 4.09075 14.2252 4.37448 14.141 4.64861C14.0567 4.92168 13.9442 5.17128 13.8034 5.39741Z" fill="#7C766B"/>
                        </svg>
                        <h6 id="item-karbohidrat-berat-bahan-karbo-3"></h6>
                      </div>
                  </div>
                </div>
              </div>
        ...
        <div class="rekomendasi-bahan-top-protein">
              <div class="food-type">
                  <img src="./images/img-telur.png" alt="food-type-img">
                  <h2 class="fw-bolder">Protein</h2>
              </div>
              <a href="/#/protein" class="text-black fs-5 lh-base">Lihat Semua</a>  
            </div>

        <div class="carousel-item active" id="item-protein">
            <div class="card-container">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="card-body-details">
                      ...
                      <div class="dose-detail">
                          <svg width="22" height="20" viewBox="0 0 23 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M20.0874 0C21.216 0 22.13 0.915076 22.13 2.0426V4.426C22.13 6.48572 21.4916 8.49481 20.3026 10.1767C19.1137 11.8587 17.4327 13.1308 15.491 13.818V14.9378C15.491 15.3779 15.3161 15.8001 15.0049 16.1114C14.6936 16.4226 14.2714 16.5975 13.8312 16.5975H8.29875C7.85856 16.5975 7.43639 16.4226 7.12513 16.1114C6.81387 15.8001 6.639 15.3779 6.639 14.9378V13.818C4.69729 13.1308 3.01629 11.8587 1.82736 10.1767C0.638435 8.49481 2.501e-05 6.48572 0 4.426V2.0426C0 0.913969 0.915075 0 2.0426 0H20.0874Z" fill="#7C766B"></path>
                          </svg>
                          <h6 id="item-protein-takaran-bahan-protein-1"></h6>
                      </div>
                      <div class="weight-detail">
                          <svg width="23" height="21" viewBox="0 0 23 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11.0674 5.39741C11.5207 5.39741 11.901 5.24381 12.2082 4.93661C12.5154 4.62941 12.6684 4.24968 12.6674 3.79741C12.6674 3.34408 12.5138 2.96381 12.2066 2.65661C11.8994 2.34941 11.5196 2.19635 11.0674 2.19741C10.614 2.19741 10.2338 2.35101 9.92657 2.65821C9.61937 2.96541 9.46631 3.34515 9.46737 3.79741C9.46737 4.25075 9.62097 4.63101 9.92817 4.93821C10.2354 5.24541 10.6151 5.39848 11.0674 5.39741ZM13.8034 5.39741H17.557C18.213 5.39741 18.7783 5.60755 19.253 6.02781C19.7266 6.44808 20.0092 6.98355 20.101 7.63421L22.1042 21.6662C22.2172 22.4406 22.0167 23.1233 21.5026 23.7142C20.9884 24.303 20.3303 24.5974 19.5282 24.5974H2.60657C1.80444 24.5974 1.14631 24.3025 0.632174 23.7126C0.118041 23.1227 -0.0824925 22.4401 0.0305742 21.6646L2.03377 7.63421C2.12551 6.98355 2.40817 6.44808 2.88177 6.02781C3.35751 5.60755 3.92337 5.39741 4.57937 5.39741H8.33298C8.19217 5.17128 8.07964 4.92168 7.99537 4.64861C7.91004 4.37448 7.86737 4.09075 7.86737 3.79741C7.86737 2.89501 8.17511 2.13608 8.79057 1.52061C9.40604 0.905146 10.165 0.597412 11.0674 0.597412C11.9698 0.597412 12.7287 0.905146 13.3442 1.52061C13.9596 2.13608 14.2674 2.89501 14.2674 3.79741C14.2674 4.09075 14.2252 4.37448 14.141 4.64861C14.0567 4.92168 13.9442 5.17128 13.8034 5.39741Z" fill="#7C766B"></path>
                          </svg>
        ...
        <div class="rekomendasi-bahan-top-lemak">
              <div class="food-type">
                  <img src="./images/img-daging.png" alt="food-type-img">
                  <h2 class="fw-bolder">Lemak</h2>
              </div>
              <a href="/#/lemak" class="text-black fs-5 lh-base">Lihat Semua</a>  
            </div>

<div class="carousel-item active" id="item-lemak">
            <div class="card-container">
                <div class="card">
                  <div class="card-body">
  ...
  async InitializeEvent() {
    ...
    try {
      ...
      await this.getKarboDataBahan();
      await this.getProteinDataBahan();
      await this.getLemakDataBahan();
    } finally {
  ...
  async getKarboDataBahan() {
    try {
      ...
      const karbohidratData = await response.json();

      const selectedData = karbohidratData.slice(4, 7);

      selectedData.forEach((data, index) => {
        const cardIndexBahan = index + 1;

        const elementIdPrefixBahan = 'item-karbohidrat';
        document.getElementById(`${elementIdPrefixBahan}-nama-bahan-karbo-${cardIndexBahan}`).innerText = this.capitalizeFirstLetter(data.nama);
        document.getElementById(`${elementIdPrefixBahan}-type-of-food-karbo-${cardIndexBahan}`).innerText = this.capitalizeFirstLetter(data.tipe_gizi.trim());
        document.getElementById(`${elementIdPrefixBahan}-takaran-bahan-karbo-${cardIndexBahan}`).innerText = data.takaran;
        document.getElementById(`${elementIdPrefixBahan}-berat-bahan-karbo-${cardIndexBahan}`).innerText = `${data.berat} gram`;

        const base64String = data.gambar;
        const imageElement = document.getElementById(`${elementIdPrefixBahan}-gambar-bahan-karbo-${cardIndexBahan}`);
  ...
  async getProteinDataBahan() {
    try {
      ...
      const selectedData = proteinData.slice(4, 7);

      selectedData.forEach((data, index) => {
        const cardIndexBahan = index + 1;

        const elementIdPrefixBahan = 'item-protein';
        document.getElementById(`${elementIdPrefixBahan}-nama-bahan-protein-${cardIndexBahan}`).innerText = this.capitalizeFirstLetter(data.nama);

        document.getElementById(`${elementIdPrefixBahan}-type-of-food-protein-${cardIndexBahan}`).innerText = this.capitalizeFirstLetter(data.tipe_gizi.trim());
        document.getElementById(`${elementIdPrefixBahan}-type-of-food-protein-${cardIndexBahan}`).style.backgroundColor = 'rgb(236, 227, 227)';
        document.getElementById(`${elementIdPrefixBahan}-type-of-food-protein-${cardIndexBahan}`).style.color = '#832B2B';

        document.getElementById(`${elementIdPrefixBahan}-takaran-bahan-protein-${cardIndexBahan}`).innerText = data.takaran;
        document.getElementById(`${elementIdPrefixBahan}-berat-bahan-protein-${cardIndexBahan}`).innerText = `${data.berat} gram`;

        const base64String = data.gambar;
        const imageElement = document.getElementById(`${elementIdPrefixBahan}-gambar-bahan-protein-${cardIndexBahan}`);
        imageElement.src = base64String;
      });
    } catch {
    }
  ...
  async getLemakDataBahan() {
    try {
      ...
      const lemakData = await response.json();

      const selectedData = lemakData.slice(4, 7);

      selectedData.forEach((data, index) => {
        const cardIndexBahan = index + 1;

        const elementIdPrefixBahan = 'item-lemak';
        document.getElementById(`${elementIdPrefixBahan}-nama-bahan-lemak-${cardIndexBahan}`).innerText = this.capitalizeFirstLetter(data.nama);

        document.getElementById(`${elementIdPrefixBahan}-type-of-food-lemak-${cardIndexBahan}`).innerText = this.capitalizeFirstLetter(data.tipe_gizi.trim());
        document.getElementById(`${elementIdPrefixBahan}-type-of-food-lemak-${cardIndexBahan}`).style.backgroundColor = 'rgb(230, 241, 255)';
        document.getElementById(`${elementIdPrefixBahan}-type-of-food-lemak-${cardIndexBahan}`).style.color = '#282B7E';

        document.getElementById(`${elementIdPrefixBahan}-takaran-bahan-lemak-${cardIndexBahan}`).innerText = data.takaran;
        document.getElementById(`${elementIdPrefixBahan}-berat-bahan-lemak-${cardIndexBahan}`).innerText = `${data.berat} gram`;

        const base64String = data.gambar;
        const imageElement = document.getElementById(`${elementIdPrefixBahan}-gambar-bahan-lemak-${cardIndexBahan}`);
        imageElement.src = base64String;
      });
    } catch {
